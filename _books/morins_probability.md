...
cover: assets/img/book_covers/morin_probability.jpg
olid: # use Open Library ID to fetch cover (if no `cover` is provided)
isbn: 9780857534521 # use ISBN to fetch cover (if no `olid` is provided, dashes are optional)
categories:
tags: Math
buy_link: https://davidmorin.physics.fas.harvard.edu/books/probability
started: 2026-01-02
finished: "?"
released: 2016
stars: "?"
...
book_type: Textbooks # Technical Reads, Textbooks
published: true
toc:
  - name: Thoughts Before Starting
    link: "#thoughts-before-starting"
  - name: Notes & Highlights
    link: "#notes--highlights"
    subsections:
      - name: "Chapter 1: Combinatorics"
        link: "#chapter-1-combinatorics"

  - name: My Solutions to the Problem Sets
    link: "#my-solutions-to-the-problem-sets"
---
