...
cover: assets/img/book_covers/the_order_of_time.jpg
olid:  # use Open Library ID to fetch cover (if no `cover` is provided)
isbn: 9780857534521 # use ISBN to fetch cover (if no `olid` is provided, dashes are optional)
categories: 
tags: top-100
buy_link: https://www.amazon.com/Boy-at-Top-Mountain/dp/1627790306
started: 2025-09-07
finished: 2025-09-08
released: 2015
stars: 5
...
book_type: Technical Reads  # Technical Reads, Textbooks
---
